...
restService.post('/v2/webhook',(req,res)=>{
 ...
 if(action === 'input.buyplan'){
    ...
    response = "Your "+planType+" plan purchase payment details are saved in our system. Please make a note, your mobile number" +<say-as interpret-as="telephone" format="91">09949337272</say-as>+ "will be used for future communications. If you wish to know anything more, please let me know.";
    console.log(response)  
