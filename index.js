...
/*if (!req.body || !req.body.result || !req.body.result.action){
 ...
 speech = 'Action missing in Request';
  ...
  speech = "currently not available.If you wish to know anything more, please let me know."; 
   ...
   speech = "Your plan purchase for "+planType+" , payment details are saved in our system. Please make a note, your mobile number "+mobile+" will be used for future communications. If you wish to know anything more, please let me know.";
      console.log(speech)
  }else{
    
   speech = "Alright. Thank you. If you wish to know anything more, please let me know.";
     console.log(speech)
  }
}*/
  return res.json({
