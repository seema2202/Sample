...
var response = 'Action missing in Request';
var speech={
...
if(req.body.result.action == 'promotions'){
  
   var response = "Promo code is travel20, promo offer is 20% off and valid upto 20-04-2018. If you wish to know anything more, please let me know."; 
    var speech={
         "fulfillmentText":response
        ,"fulfillmentMessages":[
            {
...
if(req.body.result.action == 'planhighlights'){

   var response = "currently not available.If you wish to know anything more, please let me know."; 
    var speech={
         "fulfillmentText":response
        ,"fulfillmentMessages":[
            {
...
if(req.body.result.action == 'proceed'){
   ...
   var response = "Your plan purchase for "+planType+" , payment details are saved in our system. Please make a note, your mobile number "+mobile+" will be used for future communications. If you wish to know anything more, please let me know.";
   var speech={
         "fulfillmentText":response
        ,"fulfillmentMessages":[
            {
  ...
  if(req.body.result.action == 'cancel'){
    
   var response = "Alright. Thank you. If you wish to know anything more, please let me know.";
   var speech={
         "fulfillmentText":response
        ,"fulfillmentMessages":[
            {
